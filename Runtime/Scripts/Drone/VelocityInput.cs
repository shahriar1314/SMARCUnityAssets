...
public class VelocityInput : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Debug.Log($"Initial Position SAM: x = {initialPositionSAM[0]}, y = {initialPositionSAM[1]}, z = {initialPositionSAM[2]}");
        ...
        switch (step)
        {
            case 0: // Move right
                ...
                if (currentPosition[0] >= initialPosition[0] + sideLength)
                {
                    step++; 
                    Debug.Log("1,0,0");
                }
            ...
            case 1: // Move forward
                ...
                if (currentPosition[1] >= initialPosition[1] + sideLength)
                {
                    step++; 
                    Debug.Log("0,0,1");
                }
            ...
            case 3: // Move back to the starting point
                droneController.SetTargetVelocity(new Vector3(0, 0, (float)-speed));
                if (currentPosition[1] <= initialPosition[1])
                {
                    step=0; 
                    Debug.Log("0,0,-1");
                }
